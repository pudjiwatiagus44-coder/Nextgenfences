...
一个强大的 Windows 桌面文件管理工具，支持自定义 分区（栅栏）来组织桌面文件。

## ✨ 主要特性

- 🗂️ **智能 分区**：创建可自定义的文件栅栏，整理桌面文件
- 🎨 **多种视图**：支持大图标、中图标、小图标、列表视图
- 📁 **文件夹同步**：分区 可以链接到任意文件夹，自动同步内容
- 🔄 **拖放支持**：轻松拖放文件到 分区 中
- 🖱️ **右键菜单**：完整的 Windows Shell 右键菜单支持
- 💻 **Win+D 兼容**：按 Win+D 显示桌面后自动恢复 分区 显示
...
### 创建 分区
1. 右键点击浮动球
2. 选择"创建新 分区"或"创建自定义路径 分区"
3. 输入名称并选择位置

### 使用 分区
- **拖放文件**：将文件拖到 分区 中自动移动
- **右键菜单**：右键点击文件或 分区 查看选项
- **调整大小**：拖动 分区 边缘调整大小
- **移动位置**：拖动 分区 标题栏移动
